...
El desarrollo consiste, basicamente, en aplicar un conjunto de transformaciones a una entrada, hasta obtener
una salida renderizable para la pantalla de un computador.
\newline
La entrada se encuentra descrita en una version simple de un lenguaje de marcado como HTML/XHTML
y las transformaciones principales que se aplican son: \textit{procesar el arbol del documento 
...
gramatica de XHTML y CSS, y de 48 propiedades de CSS.\\
...
Navegador Web.
\newline
Para lo cual, primeramente se comentará sobre las principales herramientas y librerias utilizadas en el proceso
...
Las principales herramientas y librerias utilizadas en el proceso de desarrollo del proyecto son:
...
\begin{itemize}
    ...
    \item \textbf{Estructura Map:} La estructura Map es parte de la librería Containers de Haskell. Esta
...
que representan la estructura |NTree|, las cuales estan descritas utilizando la herramienta UUAGC.
...
para guardar la información. Ademas, esta estructura guarda información sobre el contexto de un
...
\begin{itemize}
    ...
    \item \textit{Procesar NTree:} esta parte contiene varias tareas, pricipalmente se construye
...
\begin{figure}[H]
    \begin{center}
        \scalebox{0.35}{\includegraphics{graphics/diagr.jpg}}
    \end{center}
...
El GUI del proyecto permite modificar las hojas de estilo para |UserAgent| y |User|, y tambien
...
\begin{itemize}
        ...
        \item Aplicación parcial de funciones. Esta caracteristica permitio construir funciones
...
\begin{itemize}
        ...
        \item Dar soporte a la ideologia de implementar todo en Haskell.
\end{itemize}
